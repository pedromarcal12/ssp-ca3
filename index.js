...
router.get('/get/html', function(req, res) {
    ...
    let xml = fs.readFileSync('shopping.xml', 'utf8'),
        xsl = fs.readFileSync('shopping.xsl', 'utf8');
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        XMLtoJSON('shopping.xml', function (err, result) {
            if (err) throw (err);
            ...
            JSONtoXML('shopping.xml', result, function(err){
